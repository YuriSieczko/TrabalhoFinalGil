...
<title>SGI - @yield('titulo')</title> <!-- Bootstrap 5 / CSS -->
    ...
    <nav class="navbar sticky-top navbar-expand-md navbar-dark bg-secondary"> <div class="container-fluid"> <a
        ...
        bi-menu-button-wide" viewBox="0 0 16 16">
        <path d="M0 1.5A1.5 1.5 0 0 1 1.5 0h13A1.5 1.5 0 0 1 16 1.5v2A1.5 1.5 0 0 1 14.5 5h-13A1.5 1.5 0 0 1 0
        3.5v-2zM1.5 1a.5.5 0 0 0-.5.5v2a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-2a.5.5 0 0 0-.5-.5h-13z"/>
        <path
        ...
        <div class="collapse navbar-collapse" id="itens">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item ps-2 me-3">
                    <a id="sairBtn" class="nav-link" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#FFF"
